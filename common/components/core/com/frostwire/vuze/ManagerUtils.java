...
import com.frostwire.vuze.CoreWaiterSWT.TriggerInThread;
...
//        mb.open();
  ...
  public static void stop(DownloadManager dm) {
    ...
    public static void stop(final DownloadManager dm,
...
//      }
   ...
   */
  public static void remove(final DownloadManager dm,
            final boolean bDeleteTorrent, final boolean bDeleteData) {
    remove(dm, bDeleteTorrent, bDeleteData, null);
    }
